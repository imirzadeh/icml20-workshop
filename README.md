 ...
 * 3.2 Run ```bash replicate_appendix_d2.sh``` for the experiment in appendix D2 (Comparison with other methods with 20 tasks).     
 * 3.3 Run ```bash replicate_appendix_d3.sh```  for the experiment in appendix D3 (Stabilizing other methods).
